...
<meta name="description" content="Velvet Events & Marketing is in partnership with the leading branding company, Colourworx that specialise in flags, banners, display and branding." />
<meta name="keywords" content="events management, event service, event and marketing, event project management, road show, conference, special event and sponsorship, product launch, branding solution, wella yps, velvet, Claire Johnston, event manager, flags, banners, display, branding, fleet branding, interior and exterior décor, store fitout, facia, fascia, vehicle branding, pvc, large format, lightbox" />
<title>Velvet’s Partnership with Colourworx</title>
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','779','height','27','src','element/menu','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','element/menu' ); //end AC code
            ...
            <noscript><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="779" height="27">
        ...
        <td><table width="779" border="0" cellpadding="0"  cellspacing="0" background="element/Velvet-all-pages_02.png" class="table_fm">
          <tr>
            <td height="424" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr valign="top">
                <td><%=(Recordset1.Fields.Item("Text_Cont").Value)%></td>
              </tr>
