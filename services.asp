        ...
        <td><table width="779" border="0" cellpadding="0"  cellspacing="0" background="element/Velvet-all-pages_02.png" class="table_fm">
          <tr>
            <td height="424" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr valign="top">
                <td width="130" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="listst">

                  <tr>
                    <td width="8">&nbsp;</td>
                    <td width="20" align="center" valign="top"><img src="element/Velvet-all-pages_06.png" width="14" height="14" /></td>
                    <td><a href="services_R.asp">Roadshow</a></td>
                    </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td align="center" valign="top"><img src="element/Velvet-all-pages_06.png" alt="" width="14" height="14" /></td>
                    <td><a href="services_S.asp">Special Events<br />
&amp; Sponsorship</a></td>
                    </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td align="center" valign="top"><img src="element/Velvet-all-pages_06.png" alt="" width="14" height="14" /></td>
                    <td><a href="services_B.asp">Branding Solution</a></td>
                    </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td align="center" valign="top"><img src="element/Velvet-all-pages_06.png" alt="" width="14" height="14" /></td>
                    <td><a href="services_P.asp">Product Launch</a></td>
                    </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td align="center" valign="top"><img src="element/Velvet-all-pages_06.png" alt="" width="14" height="14" /></td>
                    <td background="services_C.asp"><a href="services_C.asp">Conference</a></td>
                    </tr>

                </table></td>
                <td width="3" valign="top"><img src="element/Velvet-all-pages_03.png" width="2" height="365" /></td>
